    ...
    >
      ...
      >
        ...
        <template v-if="error.statusCode === 404">
          <h1 class="font-mono text-white z-50 text-6xl">404</h1>
          <p class="font-mono text-white z-50 text-4xl">Извините, такой страницы не существует</p>
        </template>
        <template v-else>
          <h1 class="font-mono text-white z-50 text-6xl">Ошибка</h1>
          <p class="font-mono text-white z-50 text-6xl">
            <strong>{{ error.message }}</strong>
          </p>
          <p class="font-mono text-white z-50 text-4xl">Что-то пошло не так</p>
          <p class="font-mono text-white z-50 text-4xl">Извините за это</p>
        </template>
