...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://E:/Stusy/web-client/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/Stusy/web-client/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/Stusy/web-client/node_modules/devalue/index.js';
import destr from 'file://E:/Stusy/web-client/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://E:/Stusy/web-client/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://E:/Stusy/web-client/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://E:/Stusy/web-client/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/Stusy/web-client/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/Stusy/web-client/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/Stusy/web-client/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://E:/Stusy/web-client/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/Stusy/web-client/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/Stusy/web-client/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://E:/Stusy/web-client/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/Stusy/web-client/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/Stusy/web-client/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/Stusy/web-client/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://E:/Stusy/web-client/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file://E:/Stusy/web-client/node_modules/vue/index.mjs';
import { version, unref } from 'file://E:/Stusy/web-client/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/Stusy/web-client/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/Stusy/web-client/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/Stusy/web-client/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Stusy\\web-client","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Stusy\\web-client\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Stusy\\web-client\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Stusy\\web-client\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Stusy\\web-client\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "E:/Stusy/web-client";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _ukXXn3zXpI = (nitroApp) => {
...
const _lazy_r0omAs = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://E:/Stusy/web-client/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
